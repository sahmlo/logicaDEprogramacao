...
Neste módulo, o foco foi estruturar o raciocínio lógico para "falar a língua do computador". Os principais conceitos abordados foram:

* **Algoritmos:** Criação de sequências lógicas de passos para resolver problemas.
* **Variáveis e Tipos de Dados:** Manipulação de strings, números (int/float) e booleanos.
* **Operadores:** Aritméticos, relacionais e lógicos.
* **Estruturas Condicionais:** Tomada de decisão no código (`if`, `else`, `switch`).
* **Laços de Repetição (Loops):** Automatização de tarefas repetitivas (`for`, `while`, `do while`).
...
Para testar os códigos deste repositório:
1.  Clone este repositório: `git clone https://github.com/sahmlo/logicaDEprogramacao.git`
2.  Abra a pasta do projeto no seu editor de código (VS Code).
3.  Execute os ficheiros de acordo com a linguagem utilizada.

---
Desenvolvido por **Sara Melo** no contexto do curso de Desenvolvimento de Sistemas.
